...
\begin{equation}
	...
	= \frac{\left(0, y, L\right)\cdot\left(0, y, 0\right)}
		   {\sqrt{y^2 + L^2}\cdot y}
	\longrightarrow \cos\alpha = \frac{y}{\sqrt{y^2 + L^2}}
...
\begin{equation}
	...
	\longrightarrow \lambda = \frac{\cos\beta_0}{\cos\beta}
...
\begin{equation}
	\lambda = \sqrt{\frac{\displaystyle 1 - \left(\frac{y}{L}\right)^2}
...
\begin{figure}[H]
	...
	\includegraphics[
		width=\textwidth
	]{figuras/resultados/TP08-result.pdf}
